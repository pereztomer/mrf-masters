...
def create_phantom_with_custom_parameters(T1_map, T2_map, PD_map,B1_map, Nread, Nphase, phantom_path, device, coil_maps=None, num_coils=None):
    """
    ...
    phantom.B1 = B1_map.unsqueeze(-1).unsqueeze(0).to(torch.complex64)
