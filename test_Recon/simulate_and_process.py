...
def preprocess_raw_data(seq, signal, R, Nread, Nphase_in_practice, fourier_factor, time_steps,device, num_coils, grappa_weights_torch=None, grappa_regularization_factor=0.001):
...
def preprocess_raw_data_without_reference(seq, signal, R, Nread, Nphase_in_practice, fourier_factor, time_steps,device, num_coils, grappa_weights_torch, grappa_regularization_factor=0.001):
    kspace_frequencies = torch.Tensor(seq.calculate_kspace()[0])
...
def simulate_and_process_mri(obj_p, seq_file_path, num_coils,device,with_reference=True, grappa_weights_torch=None):
    ...
    if with_reference:
        calibration_img_sos, time_series_shots, grappa_weights_torch = preprocess_raw_data(seq_pulseq,
                                                                                           signal,
                                                                                           R,
                                                                                           Nx,
                                                                                           NySampled,
        ...
        time_series_shots = preprocess_raw_data_without_reference(seq_pulseq,
                                                                  signal,
                                                                  R,
                                                                  Nx,
                                                                  NySampled,
