...
base_path = r"C:\Users\perez\OneDrive - Technion\masters\mri_research\datasets\mrf custom dataset\epi\6.6.25\2025-06-04_epi_Nx192_Ny192_R3_part_fourier_repetitions_50"
raw_data_path = os.path.join(base_path, "data.mat")
output_dir = os.path.join(base_path, "plots")
seq_file_path = os.path.join(base_path, "2025-06-04_epi_Nx192_Ny192_R3_part_fourier_repetitions_50.seq")
