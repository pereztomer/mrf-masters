...
def main(plot: bool = False, write_seq: bool = False, seq_filename: str = 'epi_pypulseq_with_acceleration.seq'):
    # ======
    # SETUP
    # ======
    ...
    gy = pp.make_trapezoid(channel='y', system=system, area=delta_k*R, duration=dur*R)
